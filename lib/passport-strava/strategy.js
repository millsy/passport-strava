 ...
 *
 * Supported extra options for Strava:
 *   - `approval_prompt` ‘force’ or ‘auto’, ‘force’ always shows the authorization prompt, even if the user has already authorized the current application, default is ‘auto’
 *
 * @param {Object} options
 * @return {Object}
 * @api protected
 */
 Strategy.prototype.authorizationParams = function(options) {
  ...
  if (options.approval_prompt) {
    params.approval_prompt = options.approval_prompt;
  }
  return params;
};
